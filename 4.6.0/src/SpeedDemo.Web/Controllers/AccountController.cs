...
using SpeedDemo.Sessions;
using SpeedDemo.Web.Controllers.Results;
using SpeedDemo.Web.Models;
using SpeedDemo.Web.Models.Account;
...
{
    public class AccountController : SpeedDemoControllerBase
    {
